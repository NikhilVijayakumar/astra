# Overview
The feature design for Notification. This design defines the user experience, interaction flows, and UI states.

# Feature Summary
- **Purpose**: Design for Notification
...
| --------- | ----------- |
| Goal 1 | Utilize Notification for its primary purpose. |
...
| Screen | Purpose |
| ------ | ------- |
| Notification View | Main view for Notification. |
