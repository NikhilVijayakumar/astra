# Overview
The feature design for Organisms. This design defines the user experience, interaction flows, and UI states.

# Feature Summary
- **Purpose**: Design for organisms
...
| --------- | ----------- |
| Goal 1 | Utilize Organisms for its primary purpose. |

# User Journeys

### Entry Conditions
- User accesses Organisms.

### Primary Flow
1. User interacts with Organisms.
...
| Screen | Purpose |
| ------ | ------- |
| Organisms View | Main view for Organisms. |
