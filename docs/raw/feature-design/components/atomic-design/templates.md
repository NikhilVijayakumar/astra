# Overview
The feature design for Templates. This design defines the user experience, interaction flows, and UI states.

# Feature Summary
- **Purpose**: Design for templates
...
| --------- | ----------- |
| Goal 1 | Utilize Templates for its primary purpose. |

# User Journeys

### Entry Conditions
- User accesses Templates.

### Primary Flow
1. User interacts with Templates.
...
| Screen | Purpose |
| ------ | ------- |
| Templates View | Main view for Templates. |
